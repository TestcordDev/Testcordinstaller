...
func InstallLatestBuilds() (err error) {
	...
	if err != nil {
		ShowModal("Failed to install the latest TestCord builds from GitHub", "If this issue persists, visit "+SupportUrl+" for help.", err.Error())
	}
	return
}
...
func renderInstaller() g.Widget {
	...
	layout := g.Layout{
		...
		InfoModal("#patched", "Installed!", "TestCord was successfully installed!"),
		InfoModal("#unpatched", "Uninstalled", "TestCord was successfully uninstalled!"),
